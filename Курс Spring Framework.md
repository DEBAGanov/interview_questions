...
Scope: Bean в Spring может иметь различные скоупы, такие как singleton, prototype и другие. Скоуп определяет, как часто будет создаваться новый экземпляр бина и как он будет использоваться в приложении.
