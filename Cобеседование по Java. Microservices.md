...
27. Что такое OAuth?
28. Что такое закон Конвея?
29. Что вы знаете о тестировании контрактов?
30. Что такое сквозное тестирование микросервисов?
31. Для чего нужен контейнер в микросервисах?
32. Что такое DRY в микросервисной архитектуре?
33. Что такое договор, ориентированный на потребителя (CDC)?
34. Какова роль Web и RESTful API в микросервисах?
35. Что вы знаете о семантическом мониторинге в микросервисной архитектуре?
36. Как мы проводим кросс-функциональное тестирование?
37. Как устранить недетерминизм в тестировании?
38. В чем разница между макетом и заглушкой?
39. Что вы знаете о тестовой пирамиде Майка Кона?
40. Какова цель Докера?
41. Что такое канареечный релиз (Canary Releasing)?
42. Что такое непрерывная интеграция (CI)?
43. Что такое непрерывный мониторинг?
44. Какова роль архитектора в микросервисной архитектуре?
45. Можем ли мы использовать микросервисы для создания конечных автоматов?
46. Что такое реактивное расширение в микросервисах?
